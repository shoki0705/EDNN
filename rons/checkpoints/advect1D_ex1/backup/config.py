...
class Config(object):
    ...
    def __init__(self, phase='train'):
        self.is_train = (phase == "train")  #フェーズの確認
        
        parser, args = self.parse() #コマンドライン引数を格納
    ...
    def parse(self):
        ...
        # parent_parserから基本的な設定を_add_basic_config_で追加
        ...
        # pde引数でシミュレーションの種類を指定するためのサブパーサー
